    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.share_button:
                ...
                String sharingbody = "AllinOne WhatsApp sticker, hear you can find your favorite fb and telegram sticker for WhatsApp. Let me recommend you \n  " +
                                               "https://play.google.com/store/apps/details?id=com.gone.whatsappsticker";
                String shearsubject = "All in one whatsapp sticker app hear you can find all your favorite sticker ";

                sharingINtent.putExtra(Intent.EXTRA_TEXT,sharingbody);
                sharingINtent.putExtra(Intent.EXTRA_SUBJECT,shearsubject);
            ...
            case R.id.Rate_button:
                    ...
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.gone.whatsappsticker")));


                    break;
            case R.id.about_us:

                startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("https://goneprivacypolicy.blogspot.com/2019/07/all-sticker-used-in-this-applicatin-are.html")));
            ...
            case R.id.privacy_policy:
                     ...
                     startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("https://goneprivacypolicy.blogspot.com/2019/07/privacy-policy.html")));

                break;

            case R.id.telegram_group:
                startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("https://t.me/joinchat/LIEylRaFpTCeEs-y7y_IOw")));
